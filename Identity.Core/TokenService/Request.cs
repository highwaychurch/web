...
namespace Highway.Identity.Core.TokenService
{
    ...
    public class Request
    {
        ...
        readonly IDelegationRepository _delegationRepository;
        readonly GlobalConfigurationModel _configuration;
        ...
        protected virtual void AnalyzeKeyType(RequestSecurityToken rst)
        {
            ...
            {
                Tracing.Tracing.Information(String.Format("Requested KeyType: {0}", rst.KeyType));
            }
        }
        ...
        protected virtual IClaimsIdentity AnalyzeClientIdentity(IClaimsPrincipal principal)
        {
            ...
            {
                Tracing.Tracing.Error("Client Identity is anonymous");
