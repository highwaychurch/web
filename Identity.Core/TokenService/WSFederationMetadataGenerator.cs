...
namespace Highway.Identity.Core.TokenService
{
    ...
    public class WSFederationMetadataGenerator
    {
        ...
        private SecurityTokenServiceDescriptor GetTokenServiceDescriptor()
        {
            ...
            tokenService.ServiceDescription = _configurationRepository.Configuration.SiteName;
            ...
            tokenService.ClaimTypesOffered.Add(new DisplayClaim(ClaimTypes.Name));
            _userRepository.GetSupportedClaimTypes().ToList().ForEach(claimType => tokenService.ClaimTypesOffered.Add(new DisplayClaim(claimType)));
        ...
        {
            var certificate = _configurationRepository.SigningCertificate.Certificate;
