...
namespace Highway.Shared.Mvc
{
    ...
    {
        public static bool TryGetFromCookie<T>(this HttpCookieCollection cookies, string key, out T result) where T : class, new()
        {
            result = null;
            try
            {
        ...
        public static T GetFromCookie<T>(this HttpCookieCollection cookies, string key) where T : class, new()
        {
            ...
            if (cookie != null)
                return JsonConvert.DeserializeObject<T>(Encoding.UTF8.GetString(MachineKey.Decode(cookie.Value, MachineKeyProtection.Encryption)));
        ...
        public static void SaveToCookie(this HttpCookieCollection cookies, string key, object obj, bool httpOnly = true)
        {
            ...
            cookie.Value = MachineKey.Encode(Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(obj)), MachineKeyProtection.Encryption);
        }
